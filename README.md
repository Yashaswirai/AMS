...
*   **📱 Secure QR Check-in with Geolocation**: Dynamic, time-rotating QR codes that enforce student proximity to the classroom (Geofencing) to prevent proxy attendance.
*   **🤳 Multi-Angle Face Registration**: Students can self-register their biometric profiles via live webcam sequences or by uploading multi-angle facial photos directly from their dashboards.
...
*   **🔐 Strict Teacher Data Isolation**: Role-based access control guarantees teachers can only view, manage, and mark attendance for students enrolled in their explicitly assigned courses and subjects.
...
|---|---|---|
| **Presentation** | Frontend Client | React.js 18, Vite, Tailwind CSS, Redux Toolkit, HTML5-QRCode, Framer Motion |
