...
const MOCK_TEACHER_SCHEDULE = [
  { id: 1, subjectCode: 'CS-301', subjectName: 'Data Structures & Algorithms', timeSlot: '09:00 - 10:00', room: 'LHC-101', registeredCount: 54, marked: true },
  { id: 2, subjectCode: 'CS-302', subjectName: 'Database Management Systems', timeSlot: '11:00 - 12:00', room: 'LHC-101', registeredCount: 54, marked: false },
  { id: 3, subjectCode: 'CS-501', subjectName: 'Artificial Intelligence', timeSlot: '14:00 - 15:00', room: 'AI-Lab', registeredCount: 42, marked: false },
];

function TeacherDashboard() {
  const [schedule, setSchedule] = useState(MOCK_TEACHER_SCHEDULE);
          ...
          <div className="space-y-4">
            {schedule.map((item, i) => (
              <motion.div
                ...
                className="flex items-center justify-between p-4 rounded-2xl border border-[var(--border)] bg-[var(--surface)] hover:bg-[var(--surface-elevated)] transition-colors"
              >
